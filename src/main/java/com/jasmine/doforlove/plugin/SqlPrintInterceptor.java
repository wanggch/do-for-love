package com.jasmine.doforlove.plugin;
...
//        log.info("parameter object class name: {}, value: {}", parameterObject.getClass().getName(), new Gson().toJson(parameterObject));
        // Mapper参数映射信息
...
//                        log.info("property name: {}, value: {}", propertyName, parameterValue);
                        sql = sql.replaceFirst("\\?", parameterValue.replaceAll("\\\\", "\\\\\\\\"));
